"use strict";
window.ACBF_DATABASE_VERSION=6;
...
window.ACBF_DATABASE_META={
  ...
  "coverage": {
    "records": 75,
    "note": "Verified named world locations, ultimate plans, legendary encounters, and selected restored treasures. Individual chest/shanty/manuscript/fragment records are not yet complete."
  }
};
...
window.ACBF_LOCATIONS=[
  ...
  },
  {
    ...
    "verification": "Resynced verified",
    "description": "Restored treasure-map dig location.",
    "prerequisites": [
      "Restore the Tattered Map at the Treasure Dealer"
    ],
    "preparation": {
      "minimum": [
        "Restore the Tattered Map at the Treasure Dealer"
      ...
      "recommended": [
        "Approach the nearest beach or fast-travel point"
      ],
      "ideal": [
        "Complete the host island in the same visit"
      ]
    },
    "checklist": [
      "Restore the map",
    ...
    "storyRequirements": "Treasure Dealer progression",
    "nearby": [],
    "sourceNote": "Resynced coordinate and reward details verified from PC Gamer treasure-map guide (July 2026).",
  ...
  },
  {
    ...
    "description": "Restored treasure-map dig location.",
    "prerequisites": [
      "Restore the Preserved Map using warehouse fragments"
    ],
    "preparation": {
      "minimum": [
        "Restore the Preserved Map using warehouse fragments"
    ...
    "recommendedTiers": {},
    "strategy": "Dig beneath the rock archway near the northwest rowboat.",
    "rewards": [
      "Shade and Shadow Robes",
      "Wooden Eyeball trinket"
    ],
    "storyRequirements": "Treasure Dealer progression",
    "nearby": [],
    "sourceNote": "Resynced coordinate and reward details verified from PC Gamer treasure-map guide (July 2026).",
...
(() => {
  ...
  window.ACBF_DATABASE_VERSION = 7;
  window.ACBF_DATABASE_META.version = 7;
